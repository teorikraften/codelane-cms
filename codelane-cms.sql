...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 26 mars 2015 kl 21:29
...
INSERT INTO `categories` (`id`, `parent`, `token`, `name`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 0, 'cat1', 'category1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(2, 0, 'cat2', 'category2', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(3, 1, 'cat3', 'childcat1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(4, 2, 'cat4', 'childcat2', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(5, 3, 'cat5', 'childcat3First', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(6, 3, 'cat6', 'childcat3Second', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(7, 1, 'cat7', 'childcat1_2', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(8, 1, 'cat8', 'childcat1_3', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL);
...
CREATE TABLE IF NOT EXISTS `last_read` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `last_read_user_foreign` (`user`),
  KEY `last_read_pm_foreign` (`pm`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `original_files` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `original_files_pm_foreign` (`pm`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
(1, 4, 6, 4, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(2, 1, 5, 5, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(3, 5, 5, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(4, 1, 3, 7, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(5, 1, 4, 4, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(6, 4, 4, 8, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(7, 25, 1, 7, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(8, 10, 6, 3, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(9, 23, 2, 5, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(10, 23, 2, 6, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(11, 28, 7, 7, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(12, 19, 8, 5, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL);
...
CREATE TABLE IF NOT EXISTS `reviews` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `reviews_pm_foreign` (`pm`),
  KEY `reviews_user_foreign` (`user`),
  KEY `reviews_comment_foreign` (`comment`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
(3, 'maria@jdahl.se', '$2y$10$U6BKuQr75hAJ3F6gsEQNQ.KPw4fVf710I1awDi1IVkRukLuBJ0.zK', 'Maria Mogren (Verifierad)', 'verified', '2015-03-24 20:20:59', '2015-03-25 16:40:15', NULL, 'yCEl1Rz2GD5Cv4wKpaZ5JwCuN7sWCOhbeBaMXNDFHimsDme57W6sagZE1vRC'),
